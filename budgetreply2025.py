...
# The UI Part
st.title("👨‍💻 Wazzup!!!! What do you want to know about the Australian Federal Budget Reply 2025?")
prompt = st.text_area("Please enter what you want to know from the Budget Reply.")
